...
class MultipleDatetimeConfigurationType implements BaseConfigurationType
{

    public function getId()
    {
        return 'multiple-datetime';
    }
    ...
    {
        return array(
            'entry_type' => 'sonata_type_datetime_picker', //sonata_type_immutable_array
            'allow_add' => true,
            'allow_delete' => true,
            'entry_options' => array(
                //'read_only' => false,
