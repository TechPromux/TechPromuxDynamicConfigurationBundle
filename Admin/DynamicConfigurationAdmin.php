...
class DynamicConfigurationAdmin extends BaseResourceAdmin
{
    /**
     *
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        if ($this->getSubject() && $this->getSubject()->getId()) {
            ...
            $field_options_type = $this->getResourceManager()->getUtilDynamicConfigurationManager()->getDynamicConfigurationTypeById($object->getType());
